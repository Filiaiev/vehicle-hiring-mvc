<?php
    ...
    if($venue!="" && isset($venue) && $price!="" && isset($price) && $maxPassengersNum!="" && isset($maxPassengersNum) && $date!="" && isset($date)&& $pickupTime!="" && isset($pickupTime) && $returnTime!="" && isset($returnTime) && $date > date('Y-m-d') && $pickupTime < $returnTime && $maxPassengersNum > 0 && $price > 0)
    {
        $trip = new DayTrip();
